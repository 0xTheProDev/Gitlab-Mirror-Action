...
- Take a look at the Existing Issues or visit [Discussions Section](https://github.com/0xTheProDev/Gitlab-Mirror-Action/discussions) to engage into discussion about feature request or bug reporting.
...
```bash
$ git clone https://github.com/<your-username>/Gitlab-Mirror-Action
$ cd Gitlab-Mirror-Action
$ git remote add upstream https://github.com/0xTheProDev/Gitlab-Mirror-Action
$ git fetch upstream
```
